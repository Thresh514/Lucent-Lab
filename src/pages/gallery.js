...
const topRowWorks = [
    { id: 1, title: 'ABC...', color: 'bg-pink-500', content: '作品1详细内容...' },
    { id: 2, title: 'BCD...', color: 'bg-orange-500', content: '作品2详细内容...' },
    { id: 3, title: 'EFG...', color: 'bg-cyan-500', content: '作品3详细内容...' },
    { id: 4, title: 'ABC...', color: 'bg-pink-500', content: '作品4详细内容...' },
    { id: 5, title: 'BCD...', color: 'bg-orange-500', content: '作品5详细内容...' },
];

const bottomRowWorks = [
    { id: 6, title: 'NOP...', color: 'bg-amber-700', content: '作品6详细内容...' },
    { id: 7, title: 'KLM...', color: 'bg-yellow-500', content: '作品7详细内容...' },
    { id: 8, title: 'HIJ...', color: 'bg-green-500', content: '作品8详细内容...' },
    { id: 9, title: 'ABC...', color: 'bg-pink-500', content: '作品9详细内容...' },
    { id: 10, title: 'BCD...', color: 'bg-orange-500', content: '作品10详细内容...' },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-16">
          {topRowWorks.map((work, index) => (
            ...
            >
              ...
              >
                {/* 作品内容 - 条纹背景 */}
                <div className={`w-full h-full ${work.color} relative`}
                  style={{
                ...
                >
                  {/* 蓝色圆点 */}
                  <div className="absolute right-6 bottom-6 w-4 h-4 bg-blue-500 rounded-full"></div>
                </div>
          ...
          {bottomRowWorks.map((work, index) => (
            ...
            >
              ...
              >
                ...
                >
                  {/* 蓝色圆点 */}
                  <div className="absolute right-6 bottom-4 w-4 h-4 bg-blue-500 rounded-full"></div>
                </div>
